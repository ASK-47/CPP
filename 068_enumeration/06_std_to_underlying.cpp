...
int main() {
    ...
    std::cout << std::hex << std::uppercase << std::setfill('0') << std::setw(8)
              << std::to_underlying(ColorMask::red) << '\n'
    ...
    [[maybe_unused]] std::underlying_type_t<ColorMask> y = std::to_underlying(ColorMask::alpha);  // OK

    std::cout << std::setfill('0')
            << std::setw(32) << std::bitset<32> (std::to_underlying(ColorMask::red)) << '\n'
            << std::setw(32) << std::bitset<32> (std::to_underlying(ColorMask::green)) << '\n'
            << std::setw(32) << std::bitset<32> (std::to_underlying(ColorMask::blue)) << '\n'
            << std::setw(32) << std::bitset<32> (std::to_underlying(ColorMask::alpha)) << '\n';
}